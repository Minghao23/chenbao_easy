...
import {  message, Layout, Typography, Popconfirm, Modal, AutoComplete, Tag, Alert, Icon, Button, Form, Input} from 'antd';
                ...
                <Content className="content">
                    <div>
                        <div className='form_area'>
                            <Form.Item>
                                <h1 className="label"><Icon type="file-text" />&nbsp;&nbsp;聊天记录</h1>
                            ...
                            <Form.Item>
                                <h1 className="label"><Icon type="user" />&nbsp;&nbsp;请假人员</h1>
